...
![Using Mimikatz PTH to establish an RDP session with only an NTLM hash](/assets/img/pass-the-hash-with-rdp/pth_1.png)
...
![Error when Restricted Admin mode is disabled](/assets/img/pass-the-hash-with-rdp/image.png)
